...
const buttonPlaceHolder=(collection)=>{
    if(collection=='best-deal')
        return 'Add to cart'
    else if(collection=='best-seller')
        return 'Visit farm'
    else if(collection=='popular-items')
        return 'Visit category'
}

const buttonClickHandler=(collection,id)=>{
    switch(collection){
        case 'best-deal':
            return ()=>{
...
const Post = ({ id, children, collection }) => {
    return (
        <>
            <div class="post">
